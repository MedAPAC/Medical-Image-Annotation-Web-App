          ...
          <div className="flex gap-2">
            {shapes.map(({ name, icon: Icon }) => (
              <button
                ...
                className={`p-2 rounded-full border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 ${selectedShape === name
              ...
              >
                <Icon
                  className={`w-5 h-5 ${selectedShape === name ? "text-blue-700" : "text-slate-700"
                    }`}
                />
              </button>
            ))}
...
/>
              <span className="inline-flex min-w-[3ch] justify-center font-medium text-slate-800">
        ...
        {selectedFileName && (
          <div className="w-full rounded-xl bg-white/70 backdrop-blur border border-sky-100 shadow-sm px-4 py-3 flex items-center gap-6">
            <div className="classification-section flex items-center gap-4">
              ...
              <div className="viewer-container">
                <div
                  ...
                  style={{
                    ...
                    borderStyle: "solid",
                    borderColor:
                      classificationByFileAndSlice[selectedFileName]?.[
                      currentSlice
                      ] === "positive"
                        ? "green"
                        : classificationByFileAndSlice[selectedFileName]?.[
